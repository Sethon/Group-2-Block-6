		...
		for (int k = 0; k < triangles.size(); k++) {
			...
			for (int i = 0; i < trl.size(); i++) {
				...
				if (faces) {
					...
					gl.glColor3f((float) (ps.get(0).getX()/(xMax - xMin)), 
							(float) (ps.get(0).getY()/(yMax - yMin)), 
							(float) (ps.get(0).getZ()/(zMax - zMin)));
					gl.glVertex3f((float) ps.get(0).getX()/10.0f, 
							(float) ps.get(0).getY()/10.0f, (float) ps.get(0).getZ()/10.0f);
					gl.glColor3f((float) (ps.get(1).getX()/(xMax - xMin)), 
							(float) (ps.get(1).getY()/(yMax - yMin)), 
							(float) (ps.get(1).getZ()/(zMax - zMin)));
					gl.glVertex3f((float) ps.get(1).getX()/10.0f, 
							(float) ps.get(1).getY()/10.0f, (float) ps.get(1).getZ()/10.0f);
					gl.glColor3f((float) (ps.get(2).getX()/(xMax - xMin)), 
							(float) (ps.get(2).getY()/(yMax - yMin)), 
							(float) (ps.get(2).getZ()/(zMax - zMin)));
